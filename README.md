...
- Windows 发布物使用 PyInstaller 打包为单个 exe
...
5. 使用“验证清单”检查源码、exe、中文输出和发布包

## 适用环境

规范以 Windows 11 为基准，路径、终端命令和 PyInstaller 流程均按 Windows 环境编写。Linux 和 macOS 环境需要相应调整路径分隔符及打包命令。

...
> **更新记录**（近 5 条）
> - 2026-07-18 v5：统一 CLI.md 编写规范；取消简写版 CLI.md，要求已创建的 CLI.md 按实际 `--help` 结果逐条完整展开用途、完整语法、参数表和示例；v5.1：删除 SKILL.md 正文中重复的“激活条件”，触发场景只写在 frontmatter 的 `description` 中
